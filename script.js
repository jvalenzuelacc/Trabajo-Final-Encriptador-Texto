...
<html lang="es">
    ...
    <head>
        ...
        <link rel="shortcut icon" href="imagenes/Muñeco.png.png">
    ...
    <body>
        ...
        <main>
            <section>
                ...
                <div>
                    <h6 class= "restriccion">&#9888 Solo letras minúsculas y sin acentos.</h6>
                </div>
                <div class="botones">
        ...
        <footer>
            <p class="copyright">&copy Desarrollado por Jorge Valenzuela</p>
        </footer>
